...
class ResNet:
    ...
    def build(self, rgb, label_num, train_mode=None, last_layer_type = "softmax"):
        ...
        #stage3
        self.block2_0 = self.res_block_3_layers(self.block1_3, [128, 128, 512], "res3a", True, stride = 2)# 28*28*512
        self.block2_1 = self.res_block_3_layers(self.block2_0, [128, 128, 512], "res3b1")# 28*28*512
        self.block2_2 = self.res_block_3_layers(self.block2_1, [128, 128, 512], "res3b2")# 28*28*512
        self.block2_3 = self.res_block_3_layers(self.block2_2, [128, 128, 512], "res3b3")# 28*28*512
        self.block2_4 = self.res_block_3_layers(self.block2_3, [128, 128, 512], "res3b4")# 28*28*512
        self.block2_5 = self.res_block_3_layers(self.block2_4, [128, 128, 512], "res3b5")# 28*28*512
        self.block2_6 = self.res_block_3_layers(self.block2_5, [128, 128, 512], "res3b6")# 28*28*512
        self.block2_7 = self.res_block_3_layers(self.block2_6, [128, 128, 512], "res3b7")# 28*28*512
        #stage4
        ...
        self.block3_23 = self.res_block_3_layers(self.block3_22, [256, 256, 1024], "res4b23")# 14*14*1024
        self.block3_24 = self.res_block_3_layers(self.block3_23, [256, 256, 1024], "res4b24")# 14*14*1024
        self.block3_25 = self.res_block_3_layers(self.block3_24, [256, 256, 1024], "res4b25")# 14*14*1024
        self.block3_26 = self.res_block_3_layers(self.block3_25, [256, 256, 1024], "res4b26")# 14*14*1024
        self.block3_27 = self.res_block_3_layers(self.block3_26, [256, 256, 1024], "res4b27")# 14*14*1024
        self.block3_28 = self.res_block_3_layers(self.block3_27, [256, 256, 1024], "res4b28")# 14*14*1024
        self.block3_29 = self.res_block_3_layers(self.block3_28, [256, 256, 1024], "res4b29")# 14*14*1024
        self.block3_30 = self.res_block_3_layers(self.block3_29, [256, 256, 1024], "res4b30")# 14*14*1024
        self.block3_31 = self.res_block_3_layers(self.block3_30, [256, 256, 1024], "res4b31")# 14*14*1024
        self.block3_32 = self.res_block_3_layers(self.block3_31, [256, 256, 1024], "res4b32")# 14*14*1024
        self.block3_33 = self.res_block_3_layers(self.block3_32, [256, 256, 1024], "res4b33")# 14*14*1024
        self.block3_34 = self.res_block_3_layers(self.block3_33, [256, 256, 1024], "res4b34")# 14*14*1024
        self.block3_35 = self.res_block_3_layers(self.block3_34, [256, 256, 1024], "res4b35")# 14*14*1024
        #stage5
        self.block4_1 = self.res_block_3_layers(self.block3_35, [512, 512, 2048], "res5a", True, stride = 2)# 7*7
