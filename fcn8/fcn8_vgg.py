...
class FCN8VGG:
    ...
    def build(self, rgb, train=False, num_classes = 3, random_init_fc8=False,
        ...
        self.final_layer = self._upscore_layer(self.fuse_pool3,
                                             shape=[1,224,224], #change this to [16, 224, 224] when trainmode
                                             num_classes=num_classes,
                                             debug=debug, name='final_layer',
                                             ksize=16, stride=8)
        ...
        self.pred_up = tf.argmax(self.y_soft, axis = 3)
